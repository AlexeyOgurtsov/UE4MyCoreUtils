...
public:
	...
	*/
	...
	{
		return FindChildOfImpl<const RangeT::ElementType, RangeT>(InRange, InClass, TEXT(__FUNCTION__));
	}
	...
	*/
	...
	{
		return FindSubclassOfImpl<const RangeT, const RangeT::ElementType>(InRange, InClass, TEXT(__FUNCTION__));
	}
	...
	*/
	...
	{
		return FindSubclassOfImpl<RangeT, RangeT::ElementType>(InRange, InClass, TEXT(__FUNCTION__));
	}
